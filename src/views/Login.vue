<template>
  <div class="login_container">
    <div class="login_box">
      ...
      <!-- from -->
      <el-form ref="loginForm" label-width="0px" class="login_form" :rules="rules" :model="loginData">
        <!-- username -->
        ...
        <el-form-item prop="password">
          <el-input prefix-icon="el-icon-lock" v-model="loginData.password" show-password></el-input>
        </el-form-item>
        <!-- button -->
